...
# 2. Read in the Data
adult_income <- read_csv("/Users/siyona/STAT 184/Final Project/adult_income.csv")
college_majors <- read_csv("/Users/siyona/STAT 184/Final Project/college_majors.csv")
